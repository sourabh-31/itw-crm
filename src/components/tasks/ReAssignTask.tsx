...
export default function ReAssignTask() {
  ...
  const { taskId, userId, userName } = useTaskStore();
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto mt-[10px] w-4/5 text-center font-mulish text-white">
        Do you want to assign this task to &apos;{userName}&apos;? The current
        assignee, &apos;{task.taskAssignedTo[0].user.firstName}&apos;, will be

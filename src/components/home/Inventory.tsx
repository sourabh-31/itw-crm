...
export default function Inventory() {
  ...
  return (
    <Container
      name="Your Inventory"
      className="mt-4 max-w-full overflow-x-hidden rounded-none bg-transparent p-0 text-white sm:mx-4 sm:mt-0 sm:rounded-3xl sm:bg-primary-300 sm:p-4 lg:mx-0"
